											...
											<c:if test="${not empty listClass}">
												<c:forEach items="${listClass}" var="j">
													<tr>
														...
														<td>${j.diaChi}</td>
														<td>${j.moTa}</td>
														<td><a href="EditApprovedClass?idClass=${j.idL}"><i
									...
									<ul class="pagination justify-content-center">
										<c:if test="${currentPage != 1}">
											<li class="page-item"><a class="page-link"
												href="ApprovedClass?page=${currentPage - 1}">Previous</a></li>
										</c:if>
										<c:forEach begin="1" end="${noOfPages}" var="i">
											<c:choose>
												<c:when test="${currentPage eq i}">
													<li class="page-item active"><a class="page-link"
														href="ApprovedClass?page=${i}">${i}</a></li>
												</c:when>
												<c:otherwise>
													<li class="page-item"><a class="page-link"
														href="ApprovedClass?page=${i}">${i}</a></li>
										...
										<c:if test="${currentPage lt noOfPages}">
											<li class="page-item"><a class="page-link"
												href="ApprovedClass?page=${currentPage + 1}">Next</a></li>
										</c:if>
									</ul>
								</nav>
