...
@WebServlet("/ListLevel")
public class ListLevel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("account") == null) {
			...
			listLevel = levelBO.listLevel();
			if (listLevel != null) {
				request.setAttribute("listLevel", listLevel);
				notification = "load du lieu thanh cong";
				request.setAttribute("notification", notification);
				request.getServletContext().getRequestDispatcher("/WEB-INF/admin/Level/listLevel.jsp").forward(request,
						response);
				...
				RequestDispatcher dispatcher = request.getServletContext()
						.getRequestDispatcher("/WEB-INF/admin/Level/listLevel.jsp");
